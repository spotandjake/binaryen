...
Module['CallRef'] = makeExpressionWrapper(Module['_BinaryenCallRefGetId'](), {
  'getNumOperands'(expr) {
    return Module['_BinaryenCallRefGetNumOperands'](expr);
  },
  'getOperandAt'(expr, index) {
    Module['_BinaryenCallRefGetOperandAt'](expr, index);
  },
  'setOperandAt'(expr, index, operandExpr) {
    return Boolean(Module['_BinaryenCallRefSetOperandAt'](expr, index, operandExpr));
  },
  'appendOperand'(expr, operandExpr) {
